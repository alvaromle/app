...
- app-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- app-ui: main application module, development time
- app-production: module that produces a production mode WAR for deployment
