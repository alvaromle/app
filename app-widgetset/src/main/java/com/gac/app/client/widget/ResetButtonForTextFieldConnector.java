package com.gac.app.client.widget;

import com.gac.app.widget.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.gac.app.client.widget.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
